...
/// birth_death() 
///
///   this runs the birth-death step of the BDMCMC process. it can run either
///   the spatial BD or order-statistic BD process depending on the value of
///   gamma.  If the Strauss hyperprior gamma is less than 0, the order-stat
///   version is used. If gamma is a valid value [0,1], the spatial BD/Strauss
///   prior version is used. The rest of the program follows the same rule.
///
///   ARGUMENTS: 
